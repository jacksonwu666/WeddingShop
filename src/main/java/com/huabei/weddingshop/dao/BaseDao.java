...
public class BaseDao<T> {
    ...
    //查询单个值
    public Long getSingleValue(String sql,Object...params) throws SQLException {
        Long query = (Long)runner.query(DataSourceUtils.getConnection(), sql, new ScalarHandler(), params);
        return query;
    }
    //查询单个对象
